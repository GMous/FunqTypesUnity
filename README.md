# 𓆈 FunqTypes Unity
> ⚠️ This project is based on [FunqTypes](https://github.com/dnovhorodov/FunqTypes).

*A lightweight funky functional types for Unity.*
...
- ✅ **Zero Overhead** - Efficient `readonly struct` implementation
...
🔥 Star the repo (and the original one) if you find this useful! ⭐